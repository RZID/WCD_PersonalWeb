...
const Navbar = () => {
  ...
  const [menuOpen, setMenuOpen] = useState(false),
    ...
    [isDesktop, setIsDesktop] = useState(window.innerWidth >= 768),
    [showNavItems, setShowNavItems] = useState(isDesktop),
    [hideButton, setHideButton] = useState(isDesktop);
  ...
  return (
    ...
    >
      ...
      >
        <h1 className={classNames("text-lg", "text-slate-900")}>
      ...
      >
          ...
          {[
            ...
            <motion.div
              ...
              transition={{
                duration: 0.5,
                ease: "easeOut",
                delay: menuOpen ? i * 0.1 : 0, // Only delay when opening
              }}
            >
              <div
                className={classNames(
              ...
              <a
                ...
                className={classNames("hover:opacity-80", "cursor-pointer")}
              >
                {item.name}
              </a>
            </motion.div>
        ...
        {/* Smooth fade-in effect for the text */}
        <motion.div
          initial={{ opacity: 0, y: 20 }}
